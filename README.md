...
> **Son sürüm — [`v1.1.2`](https://github.com/mersel-dss/mersel-dss-agent-signer-java/releases/tag/v1.1.2)** ·
> Doğrudan indir: [`mersel-dss-agent-signer-api-1.1.2.jar`](https://github.com/mersel-dss/mersel-dss-agent-signer-java/releases/download/v1.1.2/mersel-dss-agent-signer-api-1.1.2.jar) ·
> [SHA-256](https://github.com/mersel-dss/mersel-dss-agent-signer-java/releases/download/v1.1.2/SHA256SUMS.txt) ·
> [SBOM](https://github.com/mersel-dss/mersel-dss-agent-signer-java/releases/download/v1.1.2/mersel-dss-agent-signer-api-1.1.2-bom.json) ·
