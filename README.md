...
> **Son sürüm — [`v1.1.8`](https://github.com/mersel-dss/mersel-dss-agent-signer-java/releases/tag/v1.1.8)** ·
> Doğrudan indir: [`mersel-dss-agent-signer-api-1.1.8.jar`](https://github.com/mersel-dss/mersel-dss-agent-signer-java/releases/download/v1.1.8/mersel-dss-agent-signer-api-1.1.8.jar) ·
> [SHA-256](https://github.com/mersel-dss/mersel-dss-agent-signer-java/releases/download/v1.1.8/SHA256SUMS.txt) ·
> [SBOM](https://github.com/mersel-dss/mersel-dss-agent-signer-java/releases/download/v1.1.8/mersel-dss-agent-signer-api-1.1.8-bom.json) ·
