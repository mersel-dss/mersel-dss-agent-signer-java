...
/**
 * PIN yanlış veya PIN ile login başarısız. Mesaj kasıtlı generic tutulur (PIN-locking saldırılarını
 * zorlaştırmak için).
 */
public class Pkcs11AuthException extends SignerException {
  ...
  public Pkcs11AuthException(String message) {
    super("PKCS11_AUTH_FAILED", message);
  }

  public Pkcs11AuthException(String message, Throwable cause) {
    super("PKCS11_AUTH_FAILED", message, cause);
  }
}
